...
AS 
BEGIN
	SELECT P.ID_PRODUCTO 'ID_PRODUCTO', P.NOMBRE 'NOMBRE', P.DESCRIPCION 'DESCRIPCION', P.ID_T_PRODUCTO 'ID_T_PRODUCTO', 
	P.ID_MARCA 'ID_MARCA', P.ID_PROVEEDOR 'ID_PROVEEDOR',
	P.ID_PAIS 'ID_PAIS', P.STOCK 'STOCK', P.PRECIO 'PRECIO',
	TP.ID_T_PRODUCTO 'ID_T_PRODUCTO', TP.TIPO  'TIPO' from PRODUCTOS P
